...
.m-secondary-navigator span a:active, .m-secondary-navigator span a:focus, .m-secondary-navigator span a:visited {
    color: #000;
}
...
.m-secondary-navigator span:last-child a:active, .m-secondary-navigator span:last-child a:focus, .m-secondary-navigator span:last-child a:visited {
    color: #999;
}
                ...
                <div class="address">
                    ...
                    <div class="clearfix list">
                        <div class="address-list ">
                            <div class="address-list ">
                                <div class="address-item first unselected toAddAddress">
