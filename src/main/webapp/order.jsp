    ...
    <div class="express-append">
        <div class="wrapper">
            ...
            <div>
                    ...
                    <div class="merchant clearfix">
                        ...
                        <div class="merchant-spread">
                            ...
                            <div class="form-invioce-item">
                                <div class="form-item no-border"><span class="left-label">发票类型</span>
                                    <div class="select">
                                        <div class="option-list"><span class="option active">不开发票</span><span
                                                class="option ">电子发票</span></div>
                                    </div>
                                </div>
                                <div class="form-invoice-pro"><a
                                        href="https://www.xiaomiyoupin.com/app/shop/content?id=o6448d039aa15c092"
                                        rel="noopener noreferrer" target="_blank">常见发票问题&gt;&gt;</a></div>
                            </div>
                ...
                <div class="checkout-coupons-con"><span>无可用优惠券</span></div>
            ...
            <div class="m-modal m-modal-opened modal-content" tabindex="-1" aria-label="">
                <div class="modal-data ">
                    ...
                    <div class="input-box2">
                        <div class="input-u"><input type="text" placeholder="选择省／市／区／街道" class="m-input default"
                                value="四川/成都市/金牛区/人民北路街道" readonly="">
                            <div class="hint default"> </div>
                        </div>
                    </div>
                    <div class="input-box2">
                        <div class="input-u"><textarea type="text" placeholder="详细地址"
                                class="default">龙湖上城五栋一单元</textarea>
                            <div class="hint default"> </div>
                        </div>
                    </div>
                    <div class="input-box3">
                        <div class="input-u"><input type="text" placeholder="邮政编号" class="m-input i-text default"
                                value="610036" readonly="">
                            <div class="hint default"> </div>
                        </div>
                        <div class="m-checkbox"><a class="m-icons m-icons-check-active " data-src=""
                    ...
                    <div class="selectAddress isHidden">
                        <div class="closeIcon"><a class="m-icons m-icons-close-hover " data-src=""
                                href="javascript:;"></a></div>
                        <div class="selectTitle"><span class="ts-span">选择省/自治区</span><span class="sd-span"></span><span
                                class="sd-span"></span><span class="sd-span"></span></div>
                        <div class="line"></div>
