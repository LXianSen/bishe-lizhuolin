            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-this">
                        <a class="" href="backbook.jsp">书籍管理</a>
                    </li>
                    <li class="layui-nav-item">
                    ...
                    <li class="layui-nav-item"><a href="">类别管理</a>
                    	<dl class="layui-nav-child">
                            <dd><a href="javascript:;">一级类别</a></dd>
                            <dd><a href="javascript:;">二级类别</a></dd>
                        </dl></li>
                            ...
                            <div class="layui-form-item ">
                                <div class="layui-col-md10">
                                    <div class="layui-inline">
                                        <label class="layui-form-label">一级类别名:</label>
                                        <div class="layui-input-inline">
                                            <input name="fathertype" class="layui-input" placeholder="输入书名">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
        ...
        function treeData(){
        	...
        	$.post("BookTypeShow",{typename:""},function(data){
        		...
        		data.forEach(function(item,index){
        			var ary=[],obj
        			var obj={title:item.firstname}
        			item.secondname.forEach(function(item1,index1){
        				var obj1={title:item1.name}
        				ary.push(obj1)
        			})
        			obj={title:item.firstname,children:ary}
        			treedata.push(obj)
        		})
